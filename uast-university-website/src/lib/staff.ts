    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "First elected Dean, Faculty of Science, in a two-year tenure preceding his appointment as Pioneer Vice Chancellor of UAST",
        ],
        afterBullets: [
      ...
      },
      {
        ...
        paragraphs: [
          "Prior to his appointment as Substantive Pioneer Vice Chancellor, Professor Shilgba was appointed Chairman of the University of Agriculture, Science and Technology, Ihugh Implementation Taskforce by the Governor of Benue State.",
          ...
          "His appointment as Substantive Pioneer Vice Chancellor therefore places him in the unique position of moving from the planning and implementation phase into the leadership of the University's full institutional establishment and development.",
        ],
      },
      {
        heading: "Vision for UAST",
        paragraphs: [
          "As Pioneer Vice Chancellor, Professor Shilgba is expected to lead the development of UAST as a modern, innovative and development-oriented university with strong foundations in agriculture, science, technology and entrepreneurship.",
      ...
      {
        heading: "Appointment as Pioneer Vice Chancellor",
        paragraphs: [
          "Professor Leonard Karshima Shilgba was appointed Substantive Pioneer Vice Chancellor of the University of Agriculture, Science and Technology, Ihugh, Benue State, by the Visitor of the University and Executive Governor of Benue State, His Excellency, Rev. Fr. Dr. Hyacinth Iormem Alia.",
          ...
          "As Substantive Pioneer Vice Chancellor, Professor Shilgba assumes responsibility for leading UAST through the critical formative years of its development, with the objective of establishing a strong institutional foundation upon which future generations of students, scholars and researchers can build.",
        ],
      },
      {
